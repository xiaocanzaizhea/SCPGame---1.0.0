...
public class Predator extends Human {
    public Predator(Player player, RoleTemplate roleTemplate) {
    ...
    public void initSCPPlayerInventory() {
        ...
        ShotGun shotGun = new ShotGun(itemManager.getAllGuns().get(GunType.SHOTGUN));
        Revolver revolver = new Revolver(itemManager.allGuns.get(GunType.REVOLVER));
        ...
        inventory.addItem(shotGun.createItemStack(),
                revolver.createItemStack(),
